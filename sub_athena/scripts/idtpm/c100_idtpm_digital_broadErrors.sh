...
## Follow with IDPVM
runIDPVM.py     --filesInput ${outFile}     --outputFile ${outFileIDPVM}     --doExpertPlots  --OnlyTrackingPreInclude --doTechnicalEfficiency  --doDuplicate --validateExtraTrackCollections "SiSPSeedSegmentsActsPixelTrackParticles" --doTechnicalEfficiency  --truthMinPt 2000

##
runIDTPM.py --inputFileNames AOD.acts.pool.${clusterId}.${procId}.root --outputFilePrefix IDTPM.C100_FS.ttbar_pu200 --trkAnaCfgFile /afs/cern.ch/user/p/pibutti/sw/condor_helpers/sub_athena/idtpm_jobs/TestCommand/IDTPMconfig.json
